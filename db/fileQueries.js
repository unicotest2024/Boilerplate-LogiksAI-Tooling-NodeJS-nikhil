...
async function insertFileRecordMySQL(fileData) {
  ...
  const [rows] = await db.query(`SELECT id FROM file_tbl WHERE file_name = ? ORDER BY created_at DESC LIMIT 1`, [file_name]);
